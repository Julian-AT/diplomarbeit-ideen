...
- [ ] **Phase 1: Corpus Discovery and Design Approval** - Inspect the archive and confirm the ingestion/retrieval design before indexing.
...
Plans:
- [ ] 01-01: Locate archive, unpack safely, and inventory files.
- [ ] 01-02: Characterize content, language, metadata, and parsing/OCR needs.
- [ ] 01-03: Write Corpus Report and proposed ingestion design with approval checkpoint.
...
|-------|----------------|--------|-----------|
| 1. Corpus Discovery and Design Approval | 0/3 | Not started | - |
